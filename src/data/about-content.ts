const aboutContent = {
  ...
  sections: {
    ...
    whyFrontend: {
      title: 'Why Frontend',
      tagline: '“It finally felt aligned.”',
    ...
    helloFriend: {
      title: 'Hello, Friend',
      tagline: "Wondering what it's like to work with me?",
      imageOne: '/wonder-male.png',
      imageTwo: '/speech-bubble.png',
      description: [
        {
        ...
        },
        {
          ...
          text: 'I’m always happy to mentor and support others, while staying open to suggestions and direction. I take ownership of projects and ensure they move forward smoothly, whether it means pairing on a tricky problem, reviewing a design, sharing a helpful pattern, or guiding QA.',
        },
      ],
    },
  },
